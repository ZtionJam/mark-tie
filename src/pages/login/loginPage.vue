<template>
  <div class="login_window">
    <div class="login_box">
      ...
      <m_input class="cookie_input" v-model="cookie" text="Cookie" placeholder="Please enter valid cookie"/>
      <div class="cookie_des"><span>What is a cookie? </span>:Cookie is the login credential of Baidu Tieba, which can
